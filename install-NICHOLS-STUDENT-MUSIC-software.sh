#!/bin/bash
#
# script to install NICHOLS-STUDENT-MUSIC software with an array. Taken from jamf professional services script
...
"Installing Nichols Music Lab Apps,installnimusiclabapps"
